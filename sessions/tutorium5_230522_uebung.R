...
# Aufgabe 1: Ladet alle Märchen aus dem "Data" Unterverzeichnis in eine Liste.
...
# den Tag <person></person>. Speichert die bearbeiteten Märchen im Unterverzeichnis "Output".
...
# Aufgabe 2: Ladet alle Märchen aus dem "Data" Unterverzeichnis in eine Liste.
